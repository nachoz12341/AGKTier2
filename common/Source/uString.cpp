...
int uString::IsUTF8( const char* str, int *numChars, int maxBytes, int maxChars )
{
	...
	while( *ustr )
	{
		...
		if ( (*ustr & 0xE0) == 0xC0 ) 
		{
			// two bytes
			ustr++;
			if ( (*ustr & 0xC0) != 0x80 ) return 0; // second byte must start 10xxxxxx
			ustr++;
			continue;
		}
		...
		if ( (*ustr & 0xF0) == 0xE0 ) 
		{
			...
			if ( (*ustr & 0xC0) != 0x80 ) return 0; // second byte must start 10xxxxxx
			ustr++;
			if ( (*ustr & 0xC0) != 0x80 ) return 0; // third byte must start 10xxxxxx
			ustr++;
			continue;
		}
		...
		if ( (*ustr & 0xF8) == 0xF0 ) 
		{
			...
			if ( (*ustr & 0xC0) != 0x80 ) return 0; // third byte must start 10xxxxxx
			ustr++;
			if ( (*ustr & 0xC0) != 0x80 ) return 0; // fourth byte must start 10xxxxxx
			ustr++;
			continue;
		}
	...
	while( *ptr && (const char*)ptr-str < max )
	{
		...
		else
		{
			...
			else
			{
				...
				switch( *ptr )
				{
					case 0x80: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x82; ptr2++; *ptr2 = 0xAC; ptr2++; break;
					case 0x82: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0x9A; ptr2++; break;
					case 0x83: *ptr2 = 0xC6; ptr2++; *ptr2 = 0x92; ptr2++; break;
					case 0x84: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0x9E; ptr2++; break;
					case 0x85: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0xA6; ptr2++; break;
					case 0x86: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0xA0; ptr2++; break;
					case 0x87: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0xA1; ptr2++; break;
					case 0x88: *ptr2 = 0xCB; ptr2++; *ptr2 = 0x86; ptr2++; break;
					case 0x89: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0xB0; ptr2++; break;
					case 0x8A: *ptr2 = 0xC5; ptr2++; *ptr2 = 0xA0; ptr2++; break;
					case 0x8B: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0xB9; ptr2++; break;
					case 0x8C: *ptr2 = 0xC5; ptr2++; *ptr2 = 0x92; ptr2++; break;
					case 0x8E: *ptr2 = 0xC5; ptr2++; *ptr2 = 0xBD; ptr2++; break;

					case 0x91: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0x98; ptr2++; break;
					case 0x92: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0x99; ptr2++; break;
					case 0x93: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0x9C; ptr2++; break;
					case 0x94: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0x9D; ptr2++; break;
					case 0x95: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0xA2; ptr2++; break;
					case 0x96: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0x93; ptr2++; break;
					case 0x97: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0x94; ptr2++; break;
					case 0x98: *ptr2 = 0xCB; ptr2++; *ptr2 = 0x9C; ptr2++; break;
					case 0x99: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x84; ptr2++; *ptr2 = 0xA2; ptr2++; break;
					case 0x9A: *ptr2 = 0xC5; ptr2++; *ptr2 = 0xA1; ptr2++; break;
					case 0x9B: *ptr2 = 0xE2; ptr2++; *ptr2 = 0x80; ptr2++; *ptr2 = 0xBA; ptr2++; break;
					case 0x9C: *ptr2 = 0xC5; ptr2++; *ptr2 = 0x93; ptr2++; break;
					case 0x9E: *ptr2 = 0xC5; ptr2++; *ptr2 = 0xBE; ptr2++; break;
					case 0x9F: *ptr2 = 0xC5; ptr2++; *ptr2 = 0xB8; ptr2++; break;
...
uString::uString( const uString &szString )
{
	// clear the variables and use the set function
	m_pData = 0;
	m_iNumChars = 0;
...
//****
{
	...
	// strcpy_s not supported on other platforms so we have to use this one
	strcpy ( m_pData, szUTF8String );
	m_iLength = length;
	m_iCachedCharOffset = 0;
	m_iCachedByteOffset = 0;
...
void uString::SetStr( const uString &sString )
{
	...
	strcpy ( m_pData, sString.m_pData );
...
void uString::SetStrN( const char* szString, unsigned int length )
{
	...
	m_iLength = 0;
	while( m_iLength < length && *szString )
	{
		m_pData[ m_iLength ] = *szString;
		m_iLength++;
		szString++;
	}
	//strncpy ( m_pData, szString, length );
	m_pData[ m_iLength ] = 0;
	m_iCachedByteOffset = 0;
	m_iCachedCharOffset = 0;

	if ( !IsUTF8(m_pData, (int*)&m_iNumChars) ) 
	{
		char* szUTF8String = ConvertToUTF8( m_pData, (int*)&m_iLength, (int*)&m_iNumChars );
		delete [] m_pData;
		m_pData = szUTF8String;
		m_iTotalLength = m_iLength; // this may be incorrect, but as long as it underestimates the true size then everything should work
	}
}
...
//****
{
	...
	strcpy( szNewString, szUTF8 );
	if ( szString != szUTF8 ) delete [] szUTF8;
	if ( m_pData ) 
	{
		strcat( szNewString+length, m_pData );
		delete [] m_pData;
	}
...
uString& uString::Prepend( const uString &sString )
{
	...
	strcpy( szNewString, sString.m_pData );
	if ( m_pData ) 
	{
		strcat( szNewString+sString.m_iLength, m_pData );
		delete [] m_pData;
	}
...
//****
{
	...
	strcat( m_pData+m_iLength, szUTF8 );
...
uString& uString::AppendUTF8( const char *szString )
{
	...
	strcat( m_pData+m_iLength, szString );
...
uString& uString::Append( const uString &sString )
{
	...
	strcat( m_pData+m_iLength, sString.m_pData );
...
/*
uString& uString::AppendChar( unsigned int c )
{
	if ( c == 0 ) return *this;
