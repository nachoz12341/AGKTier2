...
class DownloadNotification {
    ...
    public Notification mCurrNotification = null;
    ...
    {
        mCurrentText = "Initialising Download";
        ...
        mCurrentBuilder.setSmallIcon(android.R.drawable.stat_sys_download);
    ...
    void onDownloadStateChanged(int newState) {
        ...
        if (newState != mState) {
            ...
            mCurrNotification = mCurrentBuilder.build();
            mNotificationManager.notify(NOTIFICATION_ID, mCurrNotification);
        }
    }
