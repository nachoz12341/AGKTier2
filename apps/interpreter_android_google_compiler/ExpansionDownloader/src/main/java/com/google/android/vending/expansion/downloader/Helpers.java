    ...
    static public String getDownloaderStringResourceIDFromState(int state) {
        switch (state) {
            ...
            case IDownloaderClient.STATE_PAUSED_NETWORK_UNAVAILABLE:
                return "Paused, network unavailable";
            case IDownloaderClient.STATE_PAUSED_BY_REQUEST:
                return "Paused by request";
            case IDownloaderClient.STATE_PAUSED_WIFI_DISABLED_NEED_CELLULAR_PERMISSION:
                return "Paused, Wifi disabled, need cellular permission";
            case IDownloaderClient.STATE_PAUSED_NEED_CELLULAR_PERMISSION:
                return "Paused, need cellular permission";
            case IDownloaderClient.STATE_PAUSED_WIFI_DISABLED:
                return "Paused, wifi disabled";
            case IDownloaderClient.STATE_PAUSED_NEED_WIFI:
                return "Paused, wifi unavailable";
            case IDownloaderClient.STATE_PAUSED_ROAMING:
                return "Paused, roaming";
            case IDownloaderClient.STATE_PAUSED_NETWORK_SETUP_FAILURE:
                return "Paused, network setup failure";
            case IDownloaderClient.STATE_PAUSED_SDCARD_UNAVAILABLE:
                return "Paused, SDCard unavailable";
            case IDownloaderClient.STATE_FAILED_UNLICENSED:
                return "Failed, unlicensed";
            case IDownloaderClient.STATE_FAILED_FETCHING_URL:
                return "Failed fetching URL";
            case IDownloaderClient.STATE_FAILED_SDCARD_FULL:
                return "Failed, SDCard full";
