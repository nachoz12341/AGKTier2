...
public class DownloadNotification implements IDownloaderClient {
    ...
    public void resendState() {
    	Log.e("Download Notification resendState","State Changed: "+mState);
        if (null != mClientProxy) {
            mClientProxy.onDownloadStateChanged(mState);
        }
        else Log.e("Download Notification","CLient Proxy is null");
    }

    @Override
    public void onDownloadStateChanged(int newState) {
    	Log.e("Download Notification","State Changed: "+newState);
        if (null != mClientProxy) {
        ...
        if (newState != mState) {
            ...
            mCurrentNotification = new NotificationCompat.Builder(mContext)
    ...
    public void setMessenger(Messenger msg) {
    	Log.e("Download Notification","Creating Proxy");
