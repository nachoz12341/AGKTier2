...
bool AGKToBullet::AssertValidPhysicsWorld()
{
 ...
 bool AGKToBullet::AssertValidObject( UINT objID, const char* message ) 
{
...
btVector3 AGKToBullet::GetObjectSize( UINT objID )
{
...
btScalar AGKToBullet::GetObjectDiameter( UINT objID )
{
...
btTransform AGKToBullet::GetTransform(UINT objID, btScalar scaleFactor/* = 1.0*/)
{
...
btVector3 AGKToBullet::GetObjectScale(UINT objID)
{
	cObject3D* pObject = agk::GetObjectPtr(objID);
	return btVector3( pObject->GetScaleX(), pObject->GetScaleY(), pObject->GetScaleZ() );
}

AGKToBullet::AGKVertexData* AGKToBullet::GetVertexData( UINT objID, btScalar scaleFactor, bool bTransform )
{
