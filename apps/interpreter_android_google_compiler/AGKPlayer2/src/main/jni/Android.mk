...
LOCAL_SRC_FILES := ../../../../../../CompilerNew/Final/$(TARGET_ARCH_ABI)/libAGKCompiler.a
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/../../../../../../CompilerNew
include $(PREBUILT_STATIC_LIBRARY) 
...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../../../../../common/include \
                $(LOCAL_PATH)/../../../../../interpreter_compiler \
...
LOCAL_STATIC_LIBRARIES := AGKAndroid AGKBullet AGKAssimp AGKCompiler AGKCurl analytics app android_native_app_glue

# define IDE_ANDROID (for AGK) and use O3 optimizations
LOCAL_CFLAGS += -DIDE_ANDROID -DAGK_COMPILER_LIB -O3 -fsigned-char
